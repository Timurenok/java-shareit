...
public interface BookingService {
    ...
    List<BookingDto> findByUserId(Long bookerId, String state, Integer from, Integer size);

    List<BookingDto> findByOwnerId(Long ownerId, String state, Integer from, Integer size);
